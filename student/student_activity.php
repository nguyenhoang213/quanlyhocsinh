...
$sql = "
    SELECT DATE(hd.ThoiGian) AS Ngay, hd.MaHD, hd.MaHS, hs.Ho, hs.Ten, hd.IP, hd.ThietBi, hd.ThoiGian 
    FROM hoatdonghs hd 
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($activities_by_date as $date => $activities) {
                ...
                foreach ($activities as $activity) {
                    ...
                    echo "<td>" . htmlspecialchars($activity['MaHS']) . "</td>";
                    echo "<td>" . htmlspecialchars($activity['Ho']) . " " . htmlspecialchars($activity['Ten']) . "</td>";
